...
import com.android.spaciocrm.util.dialogs.IncomingReferralDialogFragment;
...
public class IncomingAdapter extends RecyclerView.Adapter<IncomingAdapter.ViewHolder> {
    ...
    public IncomingAdapter(Activity actvy, ArrayList<ReferralModel> pl) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IncomingReferralDialogFragment incomingReferralDialogFragment = IncomingReferralDialogFragment.newInstance(model.getTitle(), holder.getAdapterPosition());
                incomingReferralDialogFragment.show(((HomeActivity)mActivity).getSupportFragmentManager(), "IncomingReferralFragment");
            }
        });
    }
