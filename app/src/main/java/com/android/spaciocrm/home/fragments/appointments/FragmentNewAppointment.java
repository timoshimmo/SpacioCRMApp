...
import com.android.spaciocrm.util.dialogs.AptNewDatePickerFragment;
import com.android.spaciocrm.util.dialogs.AptNewTimePickerFragment;
...
public class FragmentNewAppointment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_new_appointment, container, false);
      //  Toolbar toolbar = rootView.findViewById(R.id.newAptToolbar);
        ...
        ImageButton btnClose = rootView.findViewById(R.id.btnCloseNewAppointment);
        ...
        Button btnUpdateApt = rootView.findViewById(R.id.btnUpdateAppointment);
        ...
        btnUpdateApt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void updateAppointment() {
        ...
        try {
            ...
            appointmentsArray.put(appointmentsArray.length(), aptObj);
            ...
            listEditor.putString("appointmentsData", appointmentsArray.toString());
            listEditor.apply();
        ...
        Toast.makeText(getActivity(), "Appointment Successfully Saved!", Toast.LENGTH_LONG).show();
        getActivity().onBackPressed();
    ...
    public void contactDialog() {
        ...
        btnDialogOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String result = mCModel.getContactFirstName();
                txtAptContactName.setText(result);
    ...
    public void onClick(View v) {
        ...
        if(v == btnSetDate) {
            dateFragment = new AptNewDatePickerFragment();
            dateFragment.setTargetFragment(this, DATEPICKER_FRAGMENT);
            dateFragment.show(getActivity().getSupportFragmentManager(), "New Appointment Date Picker");
        }

        if(v == btnSetTime) {
            timeFragment = new AptNewTimePickerFragment();
            timeFragment.setTargetFragment(this, TIMEPICKER_FRAGMENT);
            timeFragment.show(getActivity().getSupportFragmentManager(), "New Appointment Time Picker");
        }
    }
        ...
        switch (requestCode) {
            case DATEPICKER_FRAGMENT:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    String selectedDate = bundle.getString("NEW_SELECTED_DATE", "");
            ...
            case TIMEPICKER_FRAGMENT:
                if (resultCode == Activity.RESULT_OK) {
                    Bundle bundle = data.getExtras();
                    String selectedTime = bundle.getString("NEW_SELECTED_TIME", "");
